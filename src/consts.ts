...
export const SITE = {
  ...
  title: 'Praveenkumar S',
  /** Default meta description for pages that don't set their own. */
  description:
    'AI/ML Engineer specializing in LLMs, Agentic AI, and applied machine learning — building production AI systems, multi-agent workflows, RAG pipelines, and ML-driven solutions.',
  /** Description of the RSS feed at /rss.xml. */
  rssDescription: 'Project notes and writing from Praveenkumar S.',
...
export const SOCIAL_LINKS: readonly SocialLink[] = [
  { label: 'GitHub', href: 'https://github.com/pr4vndevhubX', icon: 'github' },
  {
    label: 'LinkedIn',
    href: 'https://www.linkedin.com/in/praveenkumarsureshofficial',
    icon: 'linkedin',
  },
  { label: 'Email', href: 'mailto:praveenkumarsuresh.official@gmail.com', icon: 'email' },
];
